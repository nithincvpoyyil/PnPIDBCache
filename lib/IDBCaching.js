...
var idbStorageWrapper;
function IDBCaching(props) {
    var _a = __assign({ keyFactory: function (url) { return (0, core_1.getHashCode)(url.toLowerCase()).toString(); }, expireFunc: function () { return (0, core_1.dateAdd)(new Date(), 'minute', 24 * 60); } }, props), keyFactory = _a.keyFactory, expireFunc = _a.expireFunc, idbParams = _a.idbParams;
    var idbCacheObserver = function (url, init, result) {
        return __awaiter(this, void 0, void 0, function () {
            var method, cacheHeader, key_1, indexdbData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(/get/i.test(method) || cacheHeader)) return [3 /*break*/, 2];
                        ...
                        if (!idbStorageWrapper) {
                            idbStorageWrapper = new IDBStorage_1.IDBStorageWrapper(idbParams);
                        }
                        return [4 /*yield*/, idbStorageWrapper.get(key_1)];
                    case 1:
                        indexdbData = _a.sent();
                        if (indexdbData == null) {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                ...
                                                return [4 /*yield*/, idbStorageWrapper.put(key_1, result1, expiryDate)];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/, [url, result1]];
                                        }
                                    });
                                });
                            });
                        ...
                        _a.label = 2;
                    case 2: return [2 /*return*/, Promise.resolve([url, init, result])];
                }
            });
        });
    };
